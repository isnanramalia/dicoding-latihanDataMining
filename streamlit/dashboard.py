""" 
sbg latihan dicoding collection: membuat report analisis data yg interkatif dan mempermudah audience utk memahami data. Dokumentasi: https://github.com/dicodingacademy/a555-dashboard
Alur Latihan:
1. Persiapan
...
all_df = pd.read_csv("all_data.csv")  # import data

# all_df memili 2 kolom yg berisi tanggal, maka kita harus mengubahnya menjadi tipe data datetime, yaitu order_date dan delivery_date. kolom order_date yg akan jd kunci dlm pembuatan filter
...
# TODO 3: Membuat komponen filter pd dashboard
...
# utk menampilkan data yg telah difilter
main_df = all_df[(all_df["order_date"] >= str(start_date)) &
                 (all_df["order_date"] <= str(end_date))]

# memanggil fungsi yg telah dibuat
...
# TODO 4: Melengkapi dashboard dgn berbagai visualisasi data
